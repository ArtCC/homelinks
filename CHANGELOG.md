...
- Redesigned app icon (`icon.svg`): rounded square with indigo gradient background, white house silhouette and a link symbol centered inside
- Renamed `favicon.svg` to `icon.svg` and updated all references in HTML and README
